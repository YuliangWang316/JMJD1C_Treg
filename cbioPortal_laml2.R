...
lihc <- cBioDataPack("laml_tcga_pan_can_atlas_2018", ask = FALSE)
...
gsva_gl<-gsva(expr = as.matrix(lihc_genexpression),gset.idx.list = geneset_list,kcdf="Gaussian",method = "gsva")
