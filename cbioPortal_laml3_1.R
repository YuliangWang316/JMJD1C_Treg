...
lihc <- cBioDataPack("laml_tcga", ask = FALSE)
...
samplesTP <- TCGAquery_SampleTypes(colnames(lihc_genexpression), typesample = c("TB"))
...
df<-subset(lihc_clinical,select =c("OS_STATUS","OS_MONTHS","J1C_signature"))
