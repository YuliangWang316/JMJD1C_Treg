...
lihc <- cBioDataPack("luad_tcga", ask = FALSE)
lihc_genexpression<-as.data.frame(lihc@ExperimentList@listData$RNA_Seq_v2_mRNA_median_Zscores@assays@data@listData,check.names =FALSE)
...
genset<-read.table("c:/Users/xjmik/Downloads/1C_signature_GSE99254.txt",sep = "\t")
