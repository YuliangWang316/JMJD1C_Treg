...
library(ggpubr)
VlnPlot(pbmc,features = "Pdcd1")+stat_compare_means()+scale_fill_manual(values = c("#00BFC4","#F8766D"))
VlnPlot(pbmc,features = "Nrp1")+stat_compare_means()+scale_fill_manual(values = c("#00BFC4","#F8766D"))
VlnPlot(pbmc,features = "Tnfrsf18")+stat_compare_means()+scale_fill_manual(values = c("#00BFC4","#F8766D"))
VlnPlot(pbmc,features = "Icos")+stat_compare_means()+scale_fill_manual(values = c("#00BFC4","#F8766D"))
VlnPlot(pbmc,features = "Ctla4")+stat_compare_means()+scale_fill_manual(values = c("#00BFC4","#F8766D"))
VlnPlot(pbmc,features = "Lag3")+stat_compare_means()+scale_fill_manual(values = c("#00BFC4","#F8766D"))
VlnPlot(pbmc,features = "Tnfrsf4")+stat_compare_means()+scale_fill_manual(values = c("#00BFC4","#F8766D"))
VlnPlot(pbmc,features = "Havcr2")+stat_compare_means()+scale_fill_manual(values = c("#00BFC4","#F8766D"))
VlnPlot(pbmc,features = "Entpd1")+stat_compare_means()+scale_fill_manual(values = c("#00BFC4","#F8766D"))
VlnPlot(pbmc,features = "Il2ra")+stat_compare_means()+scale_fill_manual(values = c("#00BFC4","#F8766D"))
