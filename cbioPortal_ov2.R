...
lihc_genexpression<-read.table("c:/Users/xjmik/Downloads/ov_tcga_pan_can_atlas_2018/data_mrna_seq_v2_rsem_zscores_ref_diploid_samples.txt",sep = "\t",header = TRUE,check.names = FALSE)
...
lihc_clinical<-read.table("c:/Users/xjmik/Downloads/ov_tcga_pan_can_atlas_2018/Merge.txt",sep = "\t",header = TRUE,row.names = 1)
